...
public class SpecimenAuton4_0 extends LinearOpMode {
    ...
    public void rotateIntakeToSheet() {
        robot.rightElbow.setPosition(0.08);
        robot.leftElbow.setPosition(0.92);
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence pushAll = drive.trajectorySequenceBuilder(preloadScoreRelease.end())
                ...
                .lineToLinearHeading(new Pose2d(-15, 13,-400),null, new ProfileAccelerationConstraint(pushSpeed))
                ...
                .lineToConstantHeading(new Vector2d(-30, 13),null, new ProfileAccelerationConstraint(pushSpeed))
                .addDisplacementMarker(()->{
                    rotateIntakeToSheet();
                })
                .waitSeconds(0.2)
                .lineToConstantHeading(new Vector2d(-30.1, 13),null, new ProfileAccelerationConstraint(pushSpeed))
                .waitSeconds(0.2)
                .lineToLinearHeading(new Pose2d(-30.2, 15,-100),null, new ProfileAccelerationConstraint(pushSpeed))
                .waitSeconds(100)
