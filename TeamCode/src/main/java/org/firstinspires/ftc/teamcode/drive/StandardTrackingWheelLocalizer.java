...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 14.3028; // in; distance between the left and right wheels
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap, List<Integer> lastTrackingEncPositions, List<Integer> lastTrackingEncVels) {
        ...
        leftEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "rightBack")); // port 3
        rightEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "leftFront")); // port 1
        frontEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "rightFront")); // port 0
