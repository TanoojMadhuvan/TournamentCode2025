...
public class BucketAuton0_4 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence preloadMove = drive.trajectorySequenceBuilder(holdPreload.end())
                ...
                .lineToLinearHeading(new Pose2d(-9, -39.3, Math.toRadians(-225)),null, new ProfileAccelerationConstraint(20))
                .addDisplacementMarker(()->{
//                    rotateIntakeToTransfer();
//                    changeVerticalPosition(-60, 60, 0.5);
                })
